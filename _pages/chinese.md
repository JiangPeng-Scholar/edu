...
- 2022年6月 ~ 2022年8月：线上暑期研究 
    ...
    - 摘要：Vlasov 动力学的高维度特性使得传统数值方法求解的开销非常大。利用解的低秩结构，人们开发了使用低秩矩阵/张量逼近的成本高效方法。然而，经常出现的情况是，给定非负矩阵（对应于数值解）的低秩逼近可能具有负元素，导致非物理解。在这项研究中，我们的目标是开发一种成本高效、保持正性并且保守的低秩方法来解决这个问题。我们设计了两种算法，一种是切空间加速交替投影算法，另一种是核范数优化，两者都保持宏观量守恒。
- 2022年12月 ~ 2023年6月于中国科大：本科毕业论文 
    ...
    - 成果：[arXiv 预印本](https://arxiv.org/pdf/2311.09119.pdf){:target="_blank"} 
